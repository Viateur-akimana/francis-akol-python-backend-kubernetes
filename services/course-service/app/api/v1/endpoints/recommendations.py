...
class RecommendationRequest(BaseModel):
    ...
    prompt: str = Field(..., min_length=3, max_length=500, description="Describe what you want to learn")
    interests: Optional[List[str]] = Field(None, description="List of your interests")
    max_results: int = Field(5, ge=1, le=20, description="Maximum number of recommendations")
...
async def suggest_courses(
    q: str = Query(..., min_length=3, max_length=500, description="What do you want to learn?"),
