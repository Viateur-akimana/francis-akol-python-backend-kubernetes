...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_course_contents_course_id'), 'course_contents', ['course_id'], unique=False)
...
def downgrade() -> None:
    # Drop triggers
    op.execute("DROP TRIGGER IF EXISTS update_course_contents_updated_at ON course_contents;")
