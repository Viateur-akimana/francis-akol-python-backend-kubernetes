...
class PaymentService:
    ...
    async def confirm_payment(
        ...
        try:
            ...
            if result["status"] == "succeeded":
                ...
                payment.transaction_id = result.get("transaction_id") or result.get("charges", {}).get("data", [{}])[0].get("id")
    ...
    async def get_user_payments(
        ...
        total = await self.payment_repository.count_user_payments(user_id, status=status_filter)
